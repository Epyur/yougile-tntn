...
- **LPI синхронизация (изменена в v0.5.0)**:
  - **YouGile → плагин**: `syncFromTasks()` матчит задачи по `aggregate_id` И по `application_external_id` (второй — fallback для разных станций)
